...
Transform Nuclie from "competitive" to **"undisputed #1 build tool"** by:
...
- [x] Persistent cache for Docker/Edge
  - [x] Create `/tmp/nuclie-cache` volume mount fallback
...
- [x] Implement Bulk Definition Delivery (`__nuclie_bulk_d`)
...
- [x] Bundle size optimization
  ...
  - [x] Remove unused CSS (Heuristic Nuclie Purge)
...
**Objective**: Replace baselines with real measurements, prove Nuclie wins
 
**Tasks**:
- [x] Docker benchmark matrix setup
- [x] Install all 7 tools: Nuclie, Vite, Webpack, Rspack, Turbopack, Angular CLI, esbuild
...
- [x] Production template (Started)
  - [x] Create `templates/nextjs-nuclie-starter`
...
- [x] `templates/nextjs-nuclie-starter/` - Starter template
...
- [ ] Built-in linter (Rome/SWC level)
  ...
  - [ ] Custom rules for Nuclie best practices
  - [ ] CLI: `nuclie lint [--fix]`

- [ ] Enhanced `nuclie doctor`
...
- [ ] ✅ Live benchmarks (benchmarks.nuclie.dev)
