...
Transform Sparx from "competitive" to **"undisputed #1 build tool"** by:
...
- [x] Persistent cache for Docker/Edge
  - [x] Create `/tmp/sparx-cache` volume mount fallback
...
- [x] Implement Bulk Definition Delivery (`__sparx_bulk_d`)
...
- [x] Bundle size optimization
  ...
  - [x] Remove unused CSS (Heuristic Sparx Purge)
...
**Objective**: Replace baselines with real measurements, prove Sparx wins
 
**Tasks**:
- [x] Docker benchmark matrix setup
- [x] Install all 7 tools: Sparx, Vite, Webpack, Rspack, Turbopack, Angular CLI, esbuild
...
- [x] Production template (Started)
  - [x] Create `templates/nextjs-sparx-starter`
...
- [x] `templates/nextjs-sparx-starter/` - Starter template
...
- [ ] Built-in linter (Rome/SWC level)
  ...
  - [ ] Custom rules for Sparx best practices
  - [ ] CLI: `sparx lint [--fix]`

- [ ] Enhanced `sparx doctor`
...
- [ ] ✅ Live benchmarks (benchmarks.sparx.dev)
