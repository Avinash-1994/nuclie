# How a Sparx Plugin Works — Internal Guide
...
This guide explains **HOW** Sparx plugins work internally, not **WHY** you should use them.
...
2. Plugin returns a `SparxPlugin` object
3. Sparx validates the plugin interface
