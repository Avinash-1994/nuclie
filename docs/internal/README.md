# Nexxo Internal Documentation — Index
...
This directory contains **internal documentation** for Nexxo governance and core engineering.
...
- ✅ **Operational truth** (how Nexxo actually works)
...
**Welcome to Nexxo governance mode.**
