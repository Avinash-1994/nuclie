# What NOT to Touch in Nexxo Core — Internal Guide
...
This guide explains **WHAT NOT TO TOUCH** in the Nexxo codebase.
...
**Think of Nexxo core as a database**:
...
**If you're unsure, ask in #nexxo-core Slack channel.**
