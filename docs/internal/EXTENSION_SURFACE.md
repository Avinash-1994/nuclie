# Sparx Extension Surface — Internal Contract
...
This document defines the **ONLY** extension points in Sparx that are safe, supported, and guaranteed stable across minor versions.
