...
Urja implements **defense-in-depth** security:
...
# Output:
✅ Signature valid
✅ Publisher: Urja Team <security@urja.dev>
...
```json
{
  ...
  "signature": {
    ...
    "signer": "Urja Team <security@urja.dev>"
  },
  "integrity": {
...
Urja applies **strict CSP** by default:
...
Urja generates **SRI hashes** for all assets:
...
Urja runs **automated security scans**:
...
```typescript
import { sanitize } from 'urja/security';
...
1. **Email**: security@urja.dev
2. **PGP Key**: [Download](https://urja.dev/security.asc)
...
urja update --security-only

# Subscribe to security advisories
urja security subscribe
```
...
- [Urja Security Blog](https://urja.dev/blog/security)
