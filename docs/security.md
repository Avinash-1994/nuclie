...
Sparx implements **defense-in-depth** security:
...
# Output:
✅ Signature valid
✅ Publisher: Sparx Team <security@sparx.dev>
...
```json
{
  ...
  "signature": {
    ...
    "signer": "Sparx Team <security@sparx.dev>"
  },
  "integrity": {
...
Sparx applies **strict CSP** by default:
...
Sparx generates **SRI hashes** for all assets:
...
Sparx runs **automated security scans**:
...
```typescript
import { sanitize } from 'sparx/security';
...
1. **Email**: security@sparx.dev
2. **PGP Key**: [Download](https://sparx.dev/security.asc)
...
sparx update --security-only

# Subscribe to security advisories
sparx security subscribe
```
...
- [Sparx Security Blog](https://sparx.dev/blog/security)
