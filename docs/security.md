...
# Output:
✅ Signature valid
✅ Publisher: Nuclie Team <security@nuclie.dev>
...
```json
{
  ...
  "signature": {
    ...
    "signer": "Nuclie Team <security@nuclie.dev>"
  },
  "integrity": {
...
Nuclie applies **strict CSP** by default:
...
Nuclie generates **SRI hashes** for all assets:
...
Nuclie runs **automated security scans**:
...
```typescript
import { sanitize } from 'nuclie/security';
...
1. **Email**: security@nuclie.dev
2. **PGP Key**: [Download](https://nuclie.dev/security.asc)
...
nuclie update --security-only

# Subscribe to security advisories
nuclie security subscribe
```
...
- [Nuclie Security Blog](https://nuclie.dev/blog/security)
