# SPARX — MASTER PROMPT (FINAL, LOCKED)

## Context
Sparx processes large dependency graphs (modules, CSS, micro-frontends).
...
## 📐 Correct Wording
Sparx does not claim infinite scalability.

**Correct phrasing**:
> “Sparx removes stack-based failure modes and scales until system memory limits.”
