...
|------|-----------|-----|-------|--------|------|--------|
| **Nexxo** | 608ms | 15ms | 500ms | 0.1MB | 2ms | 0.0KB |
| **Vite** | 425ms | 30ms | 888ms | 20.1MB | 19ms | 238.5KB |
...
| Tool | Cold Start | HMR | Build | Memory | TTFB | Bundle |
|------|-----------|-----|-------|--------|------|--------|
| **Nexxo** | 0ms | 15ms | 462ms | 0.1MB | 0ms | 0.0KB |

## SSR

| Tool | Cold Start | HMR | Build | Memory | TTFB | Bundle |
|------|-----------|-----|-------|--------|------|--------|
| **Nexxo** | 508ms | 15ms | 477ms | 0.1MB | 1ms | 0.0KB |

## Edge

| Tool | Cold Start | HMR | Build | Memory | TTFB | Bundle |
|------|-----------|-----|-------|--------|------|--------|
| **Nexxo** | 507ms | 15ms | 445ms | 0.3MB | 1ms | 0.0KB |
