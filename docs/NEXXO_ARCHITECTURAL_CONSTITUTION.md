# NEXXO — MASTER PROMPT (FINAL, LOCKED)

## Context
Nexxo processes large dependency graphs (modules, CSS, micro-frontends).
...
## 📐 Correct Wording
Nexxo does not claim infinite scalability.

**Correct phrasing**:
> “Nexxo removes stack-based failure modes and scales until system memory limits.”
