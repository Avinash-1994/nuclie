...
Build micro-frontends with Nexxo's native Module Federation support.
...
import { loadRemote } from '@nexxo/runtime/federation';
...
```typescript
import { checkRemoteHealth } from '@nexxo/runtime/federation';
