# Nuclie Adapter Governance

**Module**: 9 (Phase H.1)  
**Status**: ✅ Active  
**Enforced By**: Nuclie Core Team
...
1.  **Survive 2 minor Nuclie releases** without breaking.
...
1.  **Filesystem Constraints**:
    ...
    *   Adapters **MUST NOT** modify Nuclie Core files or Configuration.
