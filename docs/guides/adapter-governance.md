# Sparx Adapter Governance

**Module**: 9 (Phase H.1)  
**Status**: ✅ Active  
**Enforced By**: Sparx Core Team
...
1.  **Survive 2 minor Sparx releases** without breaking.
...
1.  **Filesystem Constraints**:
    ...
    *   Adapters **MUST NOT** modify Sparx Core files or Configuration.
