/**
 * Nuclie Native Federation Runtime
...
if (typeof window !== 'undefined') {
    window.__NUCLIE_FEDERATION__ = window.__NUCLIE_FEDERATION__ || new FederationRuntime();
}

// Export for module usage
export default typeof window !== 'undefined' ? window.__NUCLIE_FEDERATION__ : new FederationRuntime();

// Helper function for easier usage
export async function loadRemote(remoteName, modulePath) {
    const runtime = typeof window !== 'undefined' ? window.__NUCLIE_FEDERATION__ : new FederationRuntime();
