 ...
 * Day 17: Create-Sparx Templates Lock
 */
...
// Read real sparx version from its own package.json
function getSparxVersion(): string {
    try {
...
async function main() {
    ...
    if (!projectName || projectName.startsWith('--')) {
        console.error(red('Please specify project name: create-sparx <name> or --name <name>'));
        process.exit(1);
    }
    ...
    const sparxVersion = getSparxVersion();
