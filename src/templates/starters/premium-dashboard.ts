  ...
  return (
    <div className="app">
      ...
      <div className="viewport-container">
        ...
        >
          <h1 className="logo">⚡ Nuclie Build Tool</h1>
        ...
        >
          <p>Edit <code>src/App.tsx</code> to see HMR in action • Built with ⚡ Nuclie</p>
        </motion.div>
      </div>
    </div>
  );
...
<html lang="en">
  <head>
    ...
    <title>Premium Dashboard - Nuclie</title>
  </head>
  <body>
    <div id="root"></div>
