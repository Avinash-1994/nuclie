...
/**
 * Nuclie Compatibility Layer
 * Adapts Vite/Rollup Plugins to Nuclie Architecture
...
export class CompatPluginAdapter {
     ...
     * This allows Nuclie (using Rolldown) to bundle using WASM plugins transparently.
     */
    ...
    private runWasm(wasmBytes: Buffer, input: string): any {
        try {
            ...
            // We assume the WASM plugin complies with Nuclie V2 Plugin Protocol.
