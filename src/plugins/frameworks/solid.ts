/**
 * @nuclie/solid - Production-Grade Solid.js Plugin
 * 
 * Features:
...
export function nuclieSolid(options: SolidPluginOptions = {}): Plugin {
    const {
        hmr = true,
...
async function transformSolidJSX(
    ...
    try {
        ...
        console.warn('[nuclie-solid] Transform failed:', error);
        return null;
    }
}
