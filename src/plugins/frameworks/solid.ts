/**
 * @sparx/solid - Production-Grade Solid.js Plugin
 * 
 * Features:
...
export function sparxSolid(options: SolidPluginOptions = {}): Plugin {
    const {
        hmr = true,
...
async function transformSolidJSX(
    ...
    try {
        ...
        console.warn('[sparx-solid] Transform failed:', error);
        return null;
    }
}
