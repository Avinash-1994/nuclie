/**
 * @nuclie/vue - Production-Grade Vue Plugin
 * 
 * Features:
 * - Graph-derived HMR
...
export function nuclieVue(options: VuePluginOptions = {}): Plugin {
    const {
        hmr = true,
...
async function parseSFC(code: string, id: string): Promise<{ descriptor: SFCDescriptor; rawDescriptor?: any }> {
    try {
        ...
        console.warn('[nuclie-vue] @vue/compiler-sfc not available, using basic parser');
...
async function compileTemplate(template: string, options: any): Promise<string> {
    try {
        ...
        console.warn('[nuclie-vue] Template compilation failed:', error);
...
async function compileScriptSetup(rawDescriptor: any, options: any): Promise<string> {
    try {
        ...
        console.warn('[nuclie-vue] Script setup compilation failed:', error);
