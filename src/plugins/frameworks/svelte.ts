/**
 * @nexxo/svelte - Production-Grade Svelte Plugin
 * 
 * Features:
...
export function nexxoSvelte(options: SveltePluginOptions = {}): Plugin {
    const {
        hmr = true,
...
async function compileSvelte(
    ...
    try {
        ...
        console.warn('[nexxo-svelte] Compilation failed:', error);
        return null;
    }
}
