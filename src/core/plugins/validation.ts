...
import { NucliePlugin, PluginValidation, PluginHookName } from './types.js';
...
export class PluginValidator {
     ...
     */
    async validate(plugin: NucliePlugin, sampleHook: PluginHookName, sampleInput: any): Promise<PluginValidation> {
