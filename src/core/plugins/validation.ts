...
import { SparxPlugin, PluginValidation, PluginHookName } from './types.js';
...
export class PluginValidator {
     ...
     */
    async validate(plugin: SparxPlugin, sampleHook: PluginHookName, sampleInput: any): Promise<PluginValidation> {
