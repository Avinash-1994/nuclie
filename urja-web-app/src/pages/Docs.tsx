  ...
  port: 5174
            ...
            <section className="mb-16">
                ...
                <div className="space-y-4">
                    {[
                        { cmd: 'npx create-urja', desc: '🎨 Interactive project scaffolding with framework selection (React, Vue, Svelte, Solid, Lit, Alpine, Preact, Mithril).' },
                        { cmd: 'npx urja dev', desc: 'Starts the high-performance development server with HMR.' },
                        { cmd: 'npx urja build', desc: 'Triggers the production build pipeline with full optimizations.' },
                        { cmd: 'npx urja init', desc: 'Interactive wizard to initialize urja.config.js in your project.' },
                        { cmd: 'npx urja bootstrap', desc: 'Scaffold a new project from premium templates (React, Vue, Svelte, etc.).' },
                        { cmd: 'npx urja ssr', desc: 'Starts the universal SSR runtime for meta-frameworks (Next.js, Nuxt, Remix).' },
                        { cmd: 'npx urja audit', desc: '🛡️ Run comprehensive audits for Accessibility, Performance, SEO, and Best Practices.' },

                        { cmd: 'npx urja inspect', desc: 'Visualize and inspect the dependency graph with filtering options.' },
                        { cmd: 'npx urja report', desc: 'Generates a detailed build analytics report from the latest session.' },
                        { cmd: 'npx urja css purge', desc: 'Deep-cleans CSS by removing unused styles from your bundle.' },
                    ].map(item => (
