        ...
        <div className="animate-in fade-in duration-1000">
            <section className="mb-16 pt-12">
                ...
                <p className="text-lg text-[var(--text-secondary)] max-w-3xl">
                    Migrate your existing projects to Urja with minimal configuration changes.
                </p>
            </section>
            ...
            <section className="mb-16">
                ...
                <div className="bg-[var(--surface-color)] p-8 rounded-2xl border border-[var(--border-color)]">
                    <h3 className="text-xl font-bold mb-4">Install Urja</h3>
                    <pre className="bg-slate-900 text-white p-4 rounded-lg overflow-x-auto">
                        <code>npm install -D urja</code>
                    </pre>
                </div>
            </section>
                    ...
                    {['React', 'Vue', 'Svelte'].map((framework) => (
                        ...
                        >
                            ...
                            <p className="text-sm text-[var(--text-secondary)] mb-4">
                                Migrate your {framework} project to Urja
                            </p>
