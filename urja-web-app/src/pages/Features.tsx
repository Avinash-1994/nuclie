    ...
    const features = [
        {
            ...
            tag: "Core",
            color: "blue",
            description: "The actual engine under the hood — what runs when you type urja build.",
            items: [
                {
        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    description: "Urja reads your package.json and project structure to pick the right transformer and HMR strategy automatically.",
        ...
        },
        {
            ...
            items: [
                ...
                {
                    name: "SCSS / Sass",
                    description: "Import .scss files directly. Urja compiles them via the sass package if installed in your project.",
        ...
        },
        {
            ...
            items: [
                ...
                {
                    name: "Expose Modules",
                    description: "Any module in your app can be exposed as a federated remote and consumed by another Urja app.",
        ...
        },
        {
            ...
            tag: "Production",
            color: "amber",
            description: "What happens when you run urja build.",
            items: [
                {
                    name: "Tree Shaking",
        ...
        },
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    description: "A compatibility shim allows most Rollup-style plugins to run inside Urja with minimal changes.",
                    implementation: "Rollup hook → Urja hook mapping in the compat adapter",
        ...
        },
        {
            ...
            tag: "Quality",
            color: "red",
            description: "What we test and how we verify Urja works correctly.",
            items: [
                {
                ...
                },
                {
                    ...
                    description: "Given identical inputs, Urja always produces byte-identical output — verified by snapshot tests.",
                ...
                },
                {
                    ...
                    description: "urja doctor diagnoses common configuration problems and suggests fixes.",
            ...
            <section className="relative mb-24 pt-20 pb-12 text-center overflow-hidden">
                ...
                <div className="relative">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-500 text-sm font-bold mb-8 backdrop-blur-sm">
                        <Rocket size={16} />
                        <span>What Urja v1.0 actually ships</span>
                    </div>
            ...
            <section className="py-24 text-center border-t border-[var(--border-color)] mt-32 relative overflow-hidden">
                ...
                <div className="relative">
                    ...
                    <p className="text-xl text-[var(--text-secondary)] max-w-xl mx-auto mb-12 leading-relaxed">
                        Install Urja globally and scaffold your first project in under a minute.
                    </p>
