        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[
                        ...
                        <div key={t.name} className="p-6 rounded-2xl bg-[var(--surface-color)] border border-[var(--border-color)] hover:border-blue-500/50 transition-all group cursor-pointer"
                            onClick={() => navigator.clipboard.writeText(`npx create-urja --template ${t.name} my-app`)}>
            ...
            <section className="mb-16">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="p-8 rounded-[32px] bg-slate-900 border border-slate-800">
                        ...
                        <CodeBlock code="npx create-urja --template edge-function my-api" />
                    </div>
                    ...
                    <div className="p-8 rounded-[32px] bg-slate-900 border border-slate-800">
                        ...
                        <CodeBlock code="npx create-urja --template fintech-app my-wallet" />
                    </div>
                </div>
            </section>
            ...
            <section className="mb-16">
                ...
                <div className="p-8 rounded-[32px] border border-[var(--border-color)] bg-[var(--surface-color)]/50">
                    ...
                    <p className="text-[var(--text-secondary)] mb-6">
                        Set up a high-performance monorepo with PNPM Workspaces and Urja's graph caching. Ideal for design systems or multi-app organizations.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            <CodeBlock code="npx create-urja --template monorepo my-org" />
                        </div>
                    </div>
                </div>
            </section>
