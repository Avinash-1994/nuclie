        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="mb-12">
                ...
                <p className="text-xl text-[var(--text-secondary)] leading-relaxed max-w-3xl">
                    Extend Urja with verified, sandboxed plugins. From legacy loaders to modern frameworks, we have you covered.
                </p>
            </div>
            ...
            <section className="mb-16">
                ...
                <p className="text-[var(--text-secondary)] mb-6">
                    All official `@urja/*` plugins are cryptographically signed and run in a WASM sandbox to prevent supply-chain attacks.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[
                        { name: '@urja/plugin-react', desc: 'Fast Refresh + JSX', dl: '50k/wk' },
                        { name: '@urja/plugin-vue', desc: 'SFC + JSX Support', dl: '32k/wk' },
                        { name: '@urja/plugin-typescript', desc: 'isolatedModules: true', dl: '120k/wk' },
                        { name: '@urja/plugin-tailwind', desc: 'JIT Engine Integration', dl: '85k/wk' },
                        { name: '@urja/plugin-pwa', desc: 'Service Worker Gen', dl: '15k/wk' },
                        { name: '@urja/plugin-image', desc: 'Avif/WebP Conversion', dl: '40k/wk' }
                    ].map(p => (
            ...
            <section className="mb-16">
                ...
                <p className="text-[var(--text-secondary)] mb-6">
                    Use your favorite Vite plugins and Webpack loaders directly in Urja.
                </p>

                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div>
                        <h4 className="font-bold mb-3">Vite Plugin Adapter</h4>
                        <CodeBlock code={`import { defineConfig } from 'urja';
