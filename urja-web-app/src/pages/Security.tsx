        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="mb-12">
                ...
                <p className="text-xl text-[var(--text-secondary)] leading-relaxed max-w-3xl">
                    Urja enforces security best practices by default. From CSP to dependency scanning, we've built a fortress for your application.
                </p>
            </div>
            ...
            <section className="mb-16">
                ...
                <p className="text-[var(--text-secondary)] mb-6">
                    Urja automatically generates strict CSP headers for your application, preventing XSS attacks by default.
                </p>

                <h3 className="text-xl font-bold mb-4">Automatic Configuration</h3>
                <CodeBlock code={`// urja.config.ts
      ...
      nonce: true,    // Auto-generate nonces for scripts/styles
                ...
                <div className="mt-6 p-6 rounded-2xl bg-blue-500/5 border border-blue-500/10">
                    ...
                    <p className="text-sm text-[var(--text-secondary)]">
                        Urja injects a cryptographic nonce into every script and style tag at runtime, and adds the corresponding hash to the CSP header. Inline scripts without a valid nonce will be blocked by the browser.
                    </p>
                </div>
            </section>
            ...
            <section className="mb-16">
                ...
                <p className="text-[var(--text-secondary)] mb-6">
                    Ensure your CDN-hosted assets haven't been tampered with. Urja calculates SHA-384 hashes for all build artifacts.
                </p>
...
console.log(process.env.PUBLIC_APP_NAME);`} />
            ...
            <section className="mb-16">
                ...
                <CodeBlock code="npx urja audit --security" />
            ...
            <div className="p-8 rounded-[32px] bg-slate-900 border border-slate-800 text-slate-300">
                ...
                <p className="mb-6 text-sm leading-relaxed">
                    We take security seriously. If you find a vulnerability in Urja, please report it via our responsible disclosure program.
                </p>
                <div className="flex gap-4">
                    <a href="mailto:security@urja.dev" className="text-blue-400 hover:text-blue-300 font-bold text-sm">security@urja.dev</a>
