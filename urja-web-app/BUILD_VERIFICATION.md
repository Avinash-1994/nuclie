# ✅ URJA WEB APP - FINAL BUILD VERIFICATION
...
```bash
cd urja-web-app && rm -rf dist && npm run build
```
...
📁 Root: /home/avinash/Desktop/framework_practis/build/urja-web-app
📦 Entry: [ 'src/main.tsx' ]
📂 Output: dist
...
...
```
✅ Valid JavaScript with Urja runtime
...
### Files to Deploy
```
urja-web-app/dist/  ← Deploy this entire folder
```
