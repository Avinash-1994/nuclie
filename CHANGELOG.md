...
- **Developer Experience (Hero Tools)**
  - `urja verify`: Comprehensive project health diagnostics.
  - `urja analyze`: Build profiling and bundle composition visualization.
  - `urja report`: AI-augmented build session narration.
