/**
 * @sparx/plugin-inspect — See exactly what every plugin does to your modules
...
export function inspect(options: InspectOptions = {}) {
  ...
  return {
    ...
    configureServer(server: any) {
      ...
      console.info(`[sparx:inspect] 🔍 Inspect UI: http://localhost:5173${basePath}`);
    },
