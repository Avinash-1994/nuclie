// @sparx/plugin-legacy — Self-contained Unit Tests
...
describe('@sparx/plugin-legacy — plugin structure', () => {
  it('has correct name', () => {
    assert.equal(legacyPlugin().name, '@sparx/plugin-legacy');
  });
...
describe('@sparx/plugin-legacy — transform hook', () => {
  let savedEnv;
