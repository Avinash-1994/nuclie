        ...
        <div className="animate-in fade-in slide-in-from-bottom-6 duration-1000">
            <div className="mb-16">
                ...
                <p className="text-xl text-[var(--text-secondary)] leading-relaxed max-w-4xl">
                    Urja is built for specific architectural goals. It is not a general-purpose tool for every project. Use this guide to determine if your project meets the Urja requirements.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
                ...
                <section className="p-8 rounded-[40px] bg-emerald-500/5 border border-emerald-500/10">
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <h2 className="text-3xl font-black font-display tracking-tight">Use Urja If...</h2>
                    </div>
                ...
                <section className="p-8 rounded-[40px] bg-red-500/5 border border-red-500/10">
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <h2 className="text-3xl font-black font-display tracking-tight text-red-600">Avoid Urja If...</h2>
                    </div>
                    <ul className="space-y-6">
                        <li className="flex gap-4">
                        ...
                        <li className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-[var(--text-secondary)]">You rely on a large catalog of experimental community plugins. Urja has a frozen core and a curated plugin system.</p>
                            </div>
                        </li>
                        <li className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-[var(--text-secondary)]">Urja is fast, but it will always prioritize correctness and governance over the absolute fastest build time if a compromise is required.</p>
                            </div>
                        </li>
                    </ul>
                </section>
            ...
            <div className="p-10 rounded-[32px] bg-slate-900 border border-slate-800 text-center mb-24">
                ...
                <p className="text-slate-400 mb-8 max-w-2xl mx-auto leading-relaxed">
                    Urja is a commitment to architectural discipline. By choosing Urja, you are choosing to trade experimental flexibility for long-term stability and predictable maintenance.
                </p>
