# ✅ NUCLIE WEB APP - FINAL BUILD VERIFICATION
...
```bash
cd nuclie-web-app && rm -rf dist && npm run build
```
...
📁 Root: /home/avinash/Desktop/framework_practis/build/nuclie-web-app
📦 Entry: [ 'src/main.tsx' ]
📂 Output: dist
...
...
```
✅ Valid JavaScript with Nuclie runtime
...
### Files to Deploy
```
nuclie-web-app/dist/  ← Deploy this entire folder
```
...
**Made with ❤️ by the Nuclie team**
