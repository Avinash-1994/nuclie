...
export class UrDocsGettingStarted extends LitElement {
  ...
  render() {
    return html`
      ...
      <div class="step">
        ...
        <p>Install the Nuclie CLI globally or as a dev dependency in your project.</p>
        <pre><code>npm install -D nuclie</code></pre>
      </div>
      ...
      <div class="step">
        ...
        <pre><code>npx nuclie bootstrap</code></pre>
      </div>

      <div class="step">
        <h2><span class="step-number">03.</span> Configuration</h2>
        <p>Create an <code>nuclie.config.js</code> file in your project root. Specify your adapter and entry points.</p>
  ...
  outputDir: 'dist'
      ...
      <div class="step">
        ...
        <pre><code>npx nuclie dev</code></pre>
      </div>
    `;
  }
}
