        ...
        <div className="animate-in fade-in duration-1000">
            <div className="mb-16">
                ...
                <p className="text-xl text-[var(--text-secondary)] leading-relaxed max-w-4xl">
                    A definitive guide to the internal specifications, optimization strategies, and governance rules of the Nuclie Build Engine.
                </p>
            </div>
...
4. Plugin Injection`} />
                ...
                <SpecItem
                    ...
                    content={
                        <p>Nuclie implements a multi-layer cache. Byte-level content hashing is applied to every file in the graph. If a file's hash remains unchanged, the transformation results are pulled from the <code>.nuclie_cache</code> directory, bypassing esbuild entirely. This allows for near-zero startup times on large projects.</p>
                    }
                />
                ...
                <SpecItem
                    ...
                    content={
                        <>
                            <p>The build tool natively supports decentralized orchestration. Each build generates a <code>federation-manifest.json</code> that defines shared dependencies and remote entry points. Nuclie handles the runtime resolution without requiring heavy external runtimes.</p>
            ...
            <div className="p-10 rounded-[40px] bg-slate-900 border border-slate-800 text-center mb-24 relative overflow-hidden">
                ...
                <p className="text-slate-400 mb-8 text-sm max-w-lg mx-auto leading-relaxed">
                    Nuclie is built on a foundation of open-source excellence. Our core transformation logic and adapter templates are available for deep inspection.
                </p>
