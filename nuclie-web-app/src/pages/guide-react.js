...
export class UrGuideReact extends LitElement {
  ...
  `;
    ...
    render() {
      ...
      <p>Nuclie's React adapter focuses on absolute decoupling. It leverages <code>@babel/preset-react</code> or <code>esbuild</code> internally to handle JSX while maintaining Nuclie's strict HMR contract.</p>
      ...
      <h2>Installation</h2>
      <pre><code>npm install -D @nuclie/react-adapter react react-dom</code></pre>
  ...
  presets: ['spa']
      ...
      <h2>HMR & State</h2>
      <p>Nuclie implements a "Fast Refresh" bridge that preserves component state during development. Unlike standard Vite/Webpack plugins, this bridge is isolated within the <code>react-adapter</code> and does not modify the Nuclie core graph.</p>
