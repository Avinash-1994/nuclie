        ...
        <div className="animate-in fade-in slide-in-from-bottom-6 duration-1000">
            <div className="mb-16">
                ...
                <p className="text-xl text-[var(--text-secondary)] leading-relaxed max-w-4xl">
                    Nuclie isn't just a wrapper around existing tools. It's a completely reimagined build architecture focused on **determinism**, **isolation**, and **performance**.
                </p>
            </div>
            ...
            <FeatureCard
                ...
                description="At the center of Nuclie is a persistent, semantic dependency graph. Unlike other tools that see files as a linear list, Nuclie understands the relationships between every module."
            >
            ...
            <FeatureCard
                ...
                description="Nuclie operates on a 'Pure Data' principle. The core engine knows how to build graphs; it doesn't know what React or Vue is. This logic is strictly isolated in Adapters."
            >
                <div className="p-8 rounded-2xl border border-dashed border-[var(--border-color)] bg-[var(--surface-color)]/30">
                    <div className="flex flex-wrap gap-4 items-center justify-center">
                        <div className="px-4 py-2 rounded-lg bg-blue-500 text-white font-bold text-sm">NUCLIE CORE</div>
            ...
            <FeatureCard
                ...
                description="Dealing with ESM and CommonJS concurrently is the 'JS Hell'. Nuclie resolves this by using an honest, esbuild-backed transformation bridge that ensures all browser targets receive pure ESM."
            >
                <div className="p-2">
...
if (target === 'browser') {
  ...
  bundle_prebundled_deps();
            ...
            <FeatureCard
                ...
                description="Nuclie's Hot Module Replacement isn't just for CSS. It uses a cross-compatible invalidation model that works identically across VDOM libraries, Web Components, and raw JS modules."
            >
            ...
            <section className="mb-24 py-16 text-center border-t border-[var(--border-color)]">
                ...
                <p className="text-[var(--text-secondary)] max-w-2xl mx-auto mb-10 text-lg">
                    By focusing on these core concepts, Nuclie ensures that your build pipeline remains fast and stable, regardless of how many modules or which frameworks you add to your stack.
                </p>
