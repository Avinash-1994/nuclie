...
module.exports = {
  ...
  // Auto-detects tailwind.config.js
            ...
            description: 'Nuclie provides built-in PostCSS processing with dedicated Tailwind support for lightning-fast styling.'
        },
        sass: {
            name: 'SASS / SCSS',
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                <section>
                    ...
                    <div className="mt-8 p-6 rounded-2xl border border-[var(--border-color)] bg-[var(--surface-color)]/50">
                        ...
                        <p className="text-sm text-[var(--text-secondary)] leading-relaxed">
                            CSS transformations happen in a dedicated pre-processing phase of the Nuclie graph, ensuring that styles are correctly linked before the JS bundle is generated.
                        </p>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <CodeBlock code={`import '../styles/theme.css';`} />
                </section>
            </div>
        </div>
    );
