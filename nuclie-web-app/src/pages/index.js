  ...
  `;
    ...
    render() {
      ...
      <div class="hero">
        ...
        <p class="tagline">Nuclie is a production-grade build tool that enforces architectural discipline through a frozen core and strictly isolated framework adapters.</p>
      ...
      <div class="grid">
        <div class="card">
          ...
          <p>Whether you're using React, Vue, or Angular, Nuclie ensures that framework logic never leaks into your core engine. Each adapter operates as a pure data producer.</p>
        ...
        <div class="card">
          <h2>Neutral HMR</h2>
          <p>Nuclie's Hot Module Replacement uses a standard invalidation model that works universally across VDOM, DOM, and Web Component paradigms.</p>
        </div>
      </div>

      <div class="alert">
        <div class="alert-title">⚠️ Non-Goal: Meta-Framework Logic</div>
        <p>Nuclie is a <strong>Bundler</strong>, not a framework. It does not provide built-in SSR, file-system routing, or data-fetching hooks. It is designed to be the foundation for your custom architecture.</p>
      </div>

      <h2>How Nuclie Compares</h2>
      ...
      <p>Nuclie is built for <strong>Technical Architects</strong> who are tired of their build tool dictating their project's structure. If you need a stable, long-term foundation for a multi-framework organization, Nuclie is your tool.</p>
    `;
    }
}
