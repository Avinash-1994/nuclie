        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="mb-12">
                ...
                <p className="text-xl text-[var(--text-secondary)] leading-relaxed max-w-3xl">
                    Nuclie is a high-performance build tool designed for large-scale web applications. This guide will walk you through the installation and basic configuration.
                </p>
            </div>
            ...
            <section className="mb-16">
                ...
                <p className="text-[var(--text-secondary)] mb-4">Install the Nuclie CLI globally via npm or yarn:</p>
                <CodeBlock code="npm install -g nuclie" />
                <p className="text-[var(--text-secondary)] mt-4">For local project use, install it as a dev dependency:</p>
                <CodeBlock code="npm install --save-dev nuclie" />
            </section>
            ...
            <section className="mb-16 p-8 rounded-3xl bg-gradient-to-br from-purple-500/10 to-pink-500/10 border-2 border-purple-500/20">
                ...
                <CodeBlock code="npx create-nuclie my-awesome-app" />
            ...
            <section className="mb-16 p-8 rounded-3xl bg-gradient-to-br from-blue-500/10 to-emerald-500/10 border-2 border-blue-500/20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    ...
                    <div className="p-4 rounded-xl bg-slate-900 border border-slate-800">
                        ...
                        <CodeBlock code="npx nuclie build" language="bash" />
                    ...
                    <div className="p-4 rounded-xl bg-slate-900 border border-slate-800 md:col-span-2">
                        ...
                        <CodeBlock code="npx nuclie audit" language="bash" />
                ...
                <div className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/30">
                    <p className="text-sm text-blue-300 flex items-center gap-2">
                        ...
                        <strong>Pro Tip:</strong> Use <code className="px-2 py-1 bg-slate-900 rounded">DEBUG=true npx nuclie dev</code> to see detailed logs
                    </p>
                </div>
            </section>
            ...
            <section className="mb-16">
                ...
                <CodeBlock code="npx nuclie init" />

                <h3 className="text-xl font-bold mt-8 mb-4">Basic Configuration</h3>
                <p className="text-[var(--text-secondary)] mb-4">Create an <code>nuclie.config.js</code> file in your project root:</p>
  ...
  port: 5174
            ...
            <section className="mb-16">
                ...
                <div className="space-y-4">
                    {[
                        { cmd: 'npx create-nuclie', desc: '🎨 Interactive project scaffolding with framework selection (React, Vue, Svelte, Solid, Lit, Alpine, Preact, Mithril).' },
                        { cmd: 'npx nuclie dev', desc: 'Starts the high-performance development server with HMR.' },
                        { cmd: 'npx nuclie build', desc: 'Triggers the production build pipeline with full optimizations.' },
                        { cmd: 'npx nuclie init', desc: 'Interactive wizard to initialize nuclie.config.js in your project.' },
                        { cmd: 'npx nuclie bootstrap', desc: 'Scaffold a new project from premium templates (React, Vue, Svelte, etc.).' },
                        { cmd: 'npx nuclie ssr', desc: 'Starts the universal SSR runtime for meta-frameworks (Next.js, Nuxt, Remix).' },
                        { cmd: 'npx nuclie audit', desc: '🛡️ Run comprehensive audits for Accessibility, Performance, SEO, and Best Practices.' },

                        { cmd: 'npx nuclie inspect', desc: 'Visualize and inspect the dependency graph with filtering options.' },
                        { cmd: 'npx nuclie report', desc: 'Generates a detailed build analytics report from the latest session.' },
                        { cmd: 'npx nuclie css purge', desc: 'Deep-cleans CSS by removing unused styles from your bundle.' },
                    ].map(item => (
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-blue-100 leading-relaxed text-sm">
                            Nuclie automatically enforces dependency boundaries. If a module from your 'Core' layer attempts to import from an 'Adapter', the build will fail during the Graph Planning phase, preventing architectural erosion.
                        </p>
                    </div>
                </div>
            </div>
