                ...
                return (
                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                        ...
                        <p className="text-lg text-[var(--text-secondary)] mb-8">
                            Nuclie treats Micro-Frontends as distributed nodes in a global dependency graph.
                        </p>
                        <div className="p-8 rounded-2xl bg-slate-900 border border-slate-800 mb-10">
                            ...
                            <p className="text-slate-300 text-sm leading-relaxed mb-6">
                                When a remote is built, Nuclie generates a canonical entry point that exposes the internal graph nodes. The host does not import files; it resolves semantic identifiers.
                            </p>
            ...
            case 'getting-started':
                return (
                    ...
                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                        ...
                        <CodeBlock code={`// remote/nuclie.config.ts
import { defineConfig } from 'nuclie';
import { federation } from '@nuclie/plugin-federation';
  ...
  plugins: [
    federation({
      ...
      shared: ['react', 'react-dom', 'zustand']
                        ...
                        <CodeBlock code={`// host/nuclie.config.ts
import { defineConfig } from 'nuclie';
import { federation } from '@nuclie/plugin-federation';
                        ...
                        <div className="space-y-8 mb-16">
                            ...
                            <div className="p-8 rounded-[32px] bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
                                ...
                                <ul className="space-y-3 text-sm text-[var(--text-secondary)]">
                                    ...
                                    <li>• Dynamic script loading without Nuclie internal orchestration.</li>
                                </ul>
                            </div>
                        </div>
                ...
                return (
                    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                        ...
                        <p className="text-xl text-[var(--text-secondary)] leading-relaxed max-w-4xl mb-12">
                            Nuclie’s approach to Micro-Frontends is built on **Deterministic Federation**. It provides the power of modular development with the responsibility of explicit dependency boundaries.
                        </p>
                        ...
                        <div className="grid grid-cols-1 gap-8">
                            <div className="p-10 rounded-[40px] bg-slate-900 border border-slate-800 text-slate-100">
                                ...
                                <p className="text-slate-400 mb-6 leading-relaxed">
                                    Unlike other tools that rely on magical runtime injections, Nuclie requires all federated boundaries to be declared in the Build Graph. This ensures that every remote module is linkable and verifiable.
                                </p>
