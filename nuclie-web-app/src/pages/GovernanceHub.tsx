        ...
        <div className="animate-in fade-in duration-1000">
            <div className="mb-16">
                ...
                <p className="text-xl text-[var(--text-secondary)] leading-relaxed max-w-4xl">
                    Nuclie is built on the principle of the "Frozen Core". Our governance model ensures that your build infrastructure remains a constant, predictable utility.
                </p>
            </div>

            <HubSection icon={Lock} title="The Frozen Core Philosophy">
                <p>
                    The Nuclie core engine is strictly feature-frozen regarding its fundamental build orchestration. We do not accept feature requests that compromise the determinism of the Build Graph.
                </p>
...
- src/resolve/path-resolver.ts (LOCKED)`} />
                <p className="text-sm italic">
                    "Architecture should be boring. Nuclie ensures the foundations of your build process never shift under your feet."
                </p>
            </HubSection>
            ...
            <HubSection icon={History} title="Breaking Change Policy">
                <p>
                    Nuclie follows a strict "Long-Term Reliability" cycle. Breaking changes to the core config schema (`nuclie.config.js`) are only permitted during major release cycles, which occur no more than once every 18 months.
                </p>
            ...
            <section className="mb-24 py-16 text-center border-t border-[var(--border-color)]">
                ...
                <p className="text-[var(--text-secondary)] max-w-2xl mx-auto mb-10 text-lg">
                    We understand that build tools are the most critical piece of an organization's infrastructure. Nuclie's governance ensures that piece never breaks.
                </p>
