...
export const MfeFrameworkConstraint: React.FC = () => {
        ...
        <div className="animate-in fade-in slide-in-from-bottom-6 duration-1000 pb-24">
            ...
            <div className="mb-16">
                ...
                <h1 className="text-4xl lg:text-6xl font-black font-display mb-8 tracking-tighter leading-tight">
                    Why Nuclie Enforces One Framework per Micro-Frontend
                </h1>
                <p className="text-xl text-[var(--text-secondary)] leading-relaxed max-w-4xl">
                    Nuclie enforces one framework per micro-frontend container by design. This is an intentional architectural decision, not a technical limitation, designed to ensure determinism and long-term maintainability.
                </p>
            </div>
            ...
            {/* Nuclie's Architectural Decision */}
            <section className="mb-20">
                <h2 className="text-3xl font-black font-display mb-6 tracking-tight">Nuclie's Architectural Stance</h2>
                <div className="space-y-4 max-w-3xl">
                    <p className="text-[var(--text-secondary)] leading-relaxed">
                        Nuclie prefers preventing unsafe architectures over enabling every possible configuration. Our engine enforces a 1:1 relationship between an **Adapter** and a **Micro-Frontend Container**.
                    </p>
            ...
            <section className="mb-20">
                ...
                <p className="text-[var(--text-secondary)] mb-8 max-w-3xl">
                    You can absolutely build a multi-framework ecosystem with Nuclie. The key is in how you organize your packages.
                </p>
                <div className="p-2">
                    <CodeBlock code={`repo/
 ├─ packages/
 ...
 │   └─ design-system (Lit)   <-- Shared Web Components`} />
                ...
                <div className="space-y-4 text-sm text-[var(--text-secondary)] mt-6">
                    <p>• <strong>Isolation</strong>: Each remote has its own <code>nuclie.config.js</code> and specific adapter.</p>
            ...
            <section className="mb-20">
                <div className="p-10 rounded-[40px] bg-red-500/10 border-2 border-red-500/20 relative overflow-hidden">
                    ...
                    <div className="text-[var(--text-primary)] leading-relaxed font-medium">
                        <p className="mb-4">
                            If your use case requires running multiple frontend frameworks inside a single micro-frontend container, <strong>Nuclie is not the right tool for that case</strong>.
                        </p>
                        <p>
                            Nuclie intentionally enforces strict boundaries to preserve determinism, isolation, and long-term maintainability. We do not compromise on these principles for the sake of experimental flexibility.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <div className="text-center py-16 border-t border-[var(--border-color)]">
                <p className="text-2xl font-black font-display tracking-tight text-[var(--text-secondary)] max-w-2xl mx-auto italic leading-normal">
                    "Nuclie enforces one framework per micro-frontend not because it cannot do otherwise, but because systems that last require boundaries."
                </p>
                <div className="flex justify-center gap-6 mt-12">
                    ...
                    <a href="#/docs/decision-guide" className="text-sm font-bold text-blue-500 border-b border-blue-500 pb-1 hover:text-blue-600 transition-colors">When Not to use Nuclie</a>
                </div>
            </div>
        </div>
    );
