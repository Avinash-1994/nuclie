        ...
        <div className="animate-in fade-in duration-1000 pb-24">
            <div className="mb-16">
                ...
                <p className="text-xl text-[var(--text-secondary)] leading-relaxed max-w-4xl">
                    Nuclie isn't just a bundler; it's a quality assurance engine. With built-in support for SEO, Accessibility, and Performance auditing, you can ship production-grade software with confidence.
                </p>
            </div>
            ...
            <section className="mb-20">
                ...
                <p className="text-[var(--text-secondary)] mb-6 text-left">
                    Nuclie provides immediate feedback by automatically running audits after every successful build. You don't need to leave your terminal or run extra commands to see if your changes impacted site quality.
                </p>
                <CodeBlock code="nuclie build" />
                <p className="text-sm text-[var(--text-secondary)] mt-4 mb-6 text-left italic">
                    You can also run a targeted audit on any URL:
                </p>
                <CodeBlock code="nuclie audit --url http://localhost:5173" />
                <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="p-6 rounded-2xl border border-[var(--border-color)] bg-[var(--surface-color)]/30">
                        ...
                        <p className="text-sm text-[var(--text-secondary)] leading-relaxed text-left">
                            Configure Nuclie to block production builds if any audit score falls below your organization's threshold.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div className="text-left">
                        ...
                        <p className="text-blue-100 leading-relaxed">
                            Most tools require external plugins or CI steps for these checks. Nuclie integrates them directly into the build graph, making quality a first-class citizen of the development lifecycle. No more "fixing accessibility later"—fix it as you build.
                        </p>
                    </div>
                </div>
            </section>
