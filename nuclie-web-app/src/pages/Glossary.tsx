        ...
        <div className="animate-in fade-in slide-in-from-bottom-6 duration-1000">
            <div className="mb-16">
                ...
                <p className="text-xl text-[var(--text-secondary)] leading-relaxed max-w-4xl">
                    Deep technical definitions for the core concepts and terminologies used within the Nuclie Build Engine.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-24">
                <GlossaryItem
                    term="Build Graph"
                    definition="A directed acyclic graph representing every file (node) and import (edge) in the application. Nuclie uses this for all optimization and transformation decisions."
                    icon={Network}
                />
                <GlossaryItem
                    term="Frozen Core"
