  ...
  dev: {
    ...
    hmr: true,
        ...
        qwik: {
            ...
            install: 'npm install -g nuclie\nnuclie bootstrap --name my-app --template qwik-ts',
            preset: 'qwik',
  ...
  dev: {
    ...
    hmr: true,
        ...
        mithril: {
            ...
            install: 'npm install -g nuclie\nnuclie bootstrap --name my-app --template mithril-js',
            preset: 'mithril',
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    ...
                    <h1 className="text-4xl lg:text-5xl font-black font-display tracking-tight">Using {config.name} with Nuclie</h1>
                </div>
            ...
            <p className="text-lg text-[var(--text-secondary)] mb-10 leading-relaxed max-w-3xl">
                Nuclie provides first-class support for {config.name} through specialized adapters that isolate your framework logic from the core build engine.
            </p>
            ...
            <section className="mb-12">
                ...
                <p className="text-[var(--text-secondary)] mb-4">Update your <code>nuclie.config.js</code> to use the {config.name} adapter:</p>
            ...
            <section className="p-8 rounded-2xl bg-blue-500/5 border border-blue-500/10">
                ...
                <p className="text-sm text-[var(--text-secondary)] italic">
                    While Nuclie allows multiple frameworks in a single repository (e.g., a React Marketing site and a Vue Dashboard), it strictly enforces **one framework per runtime container**. You can mix frameworks across routes, but not within the same component tree.
                </p>
                <div className="mt-4">
