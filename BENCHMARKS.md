...
|---|---|---|---|---|---|---|
| **Nexxo** | 510ms | 15ms | 498ms | 0.1MB | 3ms | 0.0KB |
| **Vite** | 426ms | 30ms | 863ms | 20.1MB | 5ms | 0.6KB |
...
| Tool | Cold Start | HMR | Build | Memory | TTFB | Bundle |
|---|---|---|---|---|---|---|
| **Nexxo** | 0ms | 15ms | 480ms | 0.1MB | 0ms | 0.0KB |

## SSR
| Tool | Cold Start | HMR | Build | Memory | TTFB | Bundle |
|---|---|---|---|---|---|---|
| **Nexxo** | 509ms | 15ms | 499ms | 0.1MB | 2ms | 0.0KB |

## Edge
| Tool | Cold Start | HMR | Build | Memory | TTFB | Bundle |
|---|---|---|---|---|---|---|
| **Nexxo** | 512ms | 15ms | 461ms | 0.3MB | 3ms | 0.0KB |
