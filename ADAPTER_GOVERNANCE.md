# Nexxo Adapter Governance

**Module**: 9 (Phase H.1)  
**Status**: ✅ Active  
**Enforced By**: Nexxo Core Team
...
1.  **Survive 2 minor Nexxo releases** without breaking.
...
1.  **Filesystem Constraints**:
    ...
    *   Adapters **MUST NOT** modify Nexxo Core files or Configuration.
