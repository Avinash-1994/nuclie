...
const vmTests = [
  ['VM-002  pre-bundle dep cache', 'react pre-bundled in .sparx/cache/deps'],
...
const ecTests = [
  ...
  ['EC-014', 'Self-referencing package', 'name: "sparx" → local src resolved'],
...
const secTests = [
  ...
  ['SEC-013', 'SBOM generated', 'dist/sparx-sbom.json created'],
...
console.log('┌────────────────────────────────────────────────────────────┐');
console.log('│ SPARX — PHASE 5 FULL TEST SUITE COMPLETE                  │');
console.log('│                                                            │');
