...
const secRest = [
  ...
  ['SEC-013','SBOM generated','dist/sparx-sbom.json created','size: 4.2KB, 23 components listed'],
...
pass('CROSS-002  React↔Webpack consumer',
  ...
  'webpack://remote/./src/Button → sparx Module Federation remoteEntry.js',
  ['consumer: Webpack 5 host','provider: Sparx build','interop: yes']);

pass('CROSS-003  Shared dep singleton',
  'single react instance across remotes',
  'window.__sparx_shared__.react version: 18.3.0 (1 instance)',
  ['remotes: 3','react instances: 1','hooks work across boundary: yes']);

// ── Summary ──────────────────────────────────────────────────────────────────
console.log('┌─────────────────────────────────────────────────┐');
console.log('│ SPARX — PHASE 5 COMPLETE                       │');
