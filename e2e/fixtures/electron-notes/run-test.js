...
async function runTests() {
  ...
  try {
    ...
    // Write to renderer file — triggers Sparx HMR for renderer
  ...
  const mainHasMock     = mainContent2.includes('// [Sparx]') || mainContent2.includes('mock');
  const rendererHasMock = rendererContent2.includes('// [Sparx]') || rendererContent2.includes('mock');
  ...
  // ─────────────────────────────────────────────
  log(`┌─────────────────────────────────────────────────┐`);
  log(`│ SPARX — PHASE 2.14 ELECTRON COMPLETE            │`);
