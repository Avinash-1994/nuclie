    ...
    return (
        <div class="app-container">
            <header class="hero">
                ...
                <h1>Sparx <span style={{ color: '#7c3aed' }}>+ Preact</span></h1>
                <p class="subtitle">
            ...
            <div class="code-area">
                <span style={{ color: '#6366F1' }}>$</span> sparx build --optimize
                <br />
            ...
            <footer class="footer">
                Powered by <a href="https://sparx.dev" target="_blank" rel="noopener noreferrer">Sparx Build Tool</a>
            </footer>
        </div>
    );
}
