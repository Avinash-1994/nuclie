...
# Sparx v2.0 Module 1 - Project Cleanup Script
# Removes all cache directories, build outputs, and temporary files

echo "🧹 Cleaning Sparx project..."

# Remove cache directories
echo "  Removing cache directories..."
find . -type d -name ".sparx_cache" -exec rm -rf {} + 2>/dev/null || true
...
rm -rf tests/validation/temp/*/.sparx_cache 2>/dev/null || true
rm -rf tests/snapshot_test_dir/.sparx_cache 2>/dev/null || true
