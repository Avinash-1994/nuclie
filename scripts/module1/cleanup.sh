...
# Nuclie v2.0 Module 1 - Project Cleanup Script
# Removes all cache directories, build outputs, and temporary files

echo "🧹 Cleaning Nuclie project..."

# Remove cache directories
echo "  Removing cache directories..."
find . -type d -name ".nuclie_cache" -exec rm -rf {} + 2>/dev/null || true
...
rm -rf tests/validation/temp/*/.nuclie_cache 2>/dev/null || true
rm -rf tests/snapshot_test_dir/.nuclie_cache 2>/dev/null || true
